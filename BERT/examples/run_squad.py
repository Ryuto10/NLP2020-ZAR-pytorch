...
def get_final_text(pred_text, orig_text, do_lower_case, verbose_logging=False):
    ...
    # (the SQuAD utils script also does punctuation stripping/lower casing but
...
def main():
    ...
    parser.add_argument("--do_predict", action='store_true', help="Whether to run utils on the dev set.")
