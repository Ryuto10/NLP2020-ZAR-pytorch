...
""" OpenAI GPT model fine-tuning script.
    Adapted from https://github.com/huggingface/pytorch-openai-transformer-lm/blob/master/train_pseudo_bert.py
    It self adapted from https://github.com/openai/finetune-transformer-lm/blob/master/train_pseudo_bert.py
...
def main():
    ...
    parser.add_argument("--do_eval", action='store_true', help="Whether to run utils on the dev set.")
